...
sailfishDir =  os.path.join(homeDir,'%s-trinity'%(assembly),'sailfish')
readsDir = os.path.join(homeDir,'reads')
genomePath = os.path.realpath(os.path.join(homeDir,'%s-trinity'%(assembly),'Trinity.fasta'))
...
if __name__ == "__main__":
    ...
    for s,sample in enumerate(sampleList):
        outDir = os.path.join(sailfishDir,sample)
