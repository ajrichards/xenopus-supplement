...
edgerIds1, edgerColumns1, edgerMat1 = read_de_results(edgerResultsPath1,tool='edgeR')
deseqResultsPath1 = os.path.join(featuresDir,"deseq_%s_de.csv"%(transcript))
deseqIds1, deseqColumns1, deseqMat1 = read_de_results(deseqResultsPath,tool='DESeq')
edgerResultsPath2 = os.path.join(featuresDir,"edger_%s_behavior_de.csv"%(transcript))
edgerIds2, edgerColumns2, edgerMat2 = read_de_results(edgerResultsPath2,tool='edgeR')
deseqResultsPath2 = os.path.join(featuresDir,"deseq_%s_behavior_de.csv"%(transcript))
deseqIds2, deseqColumns2, deseqMat2 = read_de_results(deseqResultsPath2,tool='DESeq')
